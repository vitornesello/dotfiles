...
brew install coreutils zsh emacs fzf tmux starship tree bat tig htop rsync postgresql antigen thefuck watch kubectl graphviz terraform helm jq git-delta
